...
Améliorations : Tavily (web temps réel), sélection auto du modèle,
historique de session, mode animateur, export, détection de langue.
"""
...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("v4.0 · Groq + Tavily · EMI")
